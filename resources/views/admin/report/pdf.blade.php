...
<body>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="2" style="text-align: center">
                    <span style="font-size: 25px; font-weight: bold; ">Sistema de Ventas Sumajst</span>
                </td>
            </tr>
            <tr>
    ...
    <section class="datos">
        <div>
            <table class="tabla" style="width: 100%; margin-top: -90px;">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td width="60" style="text-align: center">
                    Soporte técnico Autorizado Sumaj
                </td>
            </tr>
        </table>
    </section>
