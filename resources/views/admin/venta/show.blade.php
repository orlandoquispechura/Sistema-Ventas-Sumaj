    ...
    <div class="card">
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-md-3 text-center">
                    <label class="form-control-label" ><strong>Fecha</strong></label>
                    <p>{{ \Carbon\Carbon::parse($venta->fecha_venta)->format('d-M-y H:i a') }}</p>
                </div>
            </div>
        ...
        <div class="card-footer text-muted">
            <a href="{{route('admin.ventas.index')}}" class="btn btn-secondary float-right">Regresar</a>
        </div>
    </div>
</div>
@stop
