                ...
                <div class="col-sm-12 col-md-3">
                    ...
                    <div class="row ">
                        <div class="col-12 col-md-12">
                            ...
                            <div class="form-group">
                                <input class="form-control flatpickr" wire:model="desde" type="text"
                        ...
                        <div class="col-12 col-md-12">
                            ...
                            <div class="form-group">
                                <input class="form-control flatpickr" wire:model="hasta" type="text"
                                    placeholder="click para elegir">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 text-center">
                            <div class="form-group">
                                <button type="submit" id="consultar" wire:click="$refresh"
                                    class="btn btn-secondary btn-sm btn-block">Consultar <i class="fas fa-search"></i>
                                </button>
                            </div>
                        </div>
