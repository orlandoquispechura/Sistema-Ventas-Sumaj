...
@section('content')
    @can('clientes.create')
        <a href="{{ route('admin.clientes.create') }}" class="btn btn-secondary mb-2">Crear Cliente +</a>
    @endcan
                        ...
                        <tr>
                            ...
                            <td class="text-right"  style="width: 100px;">
                                <form action="{{ route('admin.clientes.destroy', $cliente) }}" method="POST"
                                    ...
                                    @csrf
                                    @can('clientes.show')
                                        <a href="{{ route('admin.clientes.show', $cliente) }}" class="btn btn-info"><i class="fas fa-eye"></i></a>
                                    @endcan
                                    @can('clientes.edit')
                                        <a href="{{ route('admin.clientes.edit', $cliente) }}" class="btn btn-success "><i class="fas fa-pen-alt"></i>
                                        </a>
                                    @endcan
