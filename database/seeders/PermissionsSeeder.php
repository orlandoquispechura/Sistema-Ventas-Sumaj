...
class PermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create([
            // 'name'=>'Navegar marcas',
            'name'          =>'marcas.index',
            'description'   =>'Lista y navega en las marca del sistema.',
        ]);
        Permission::create([
            // 'name'=>'Edición de marcas',
            'name'          =>'marcas.edit',
            'description'   =>'Edita cualquier dato de una marca del sistema.',
        ]);
        Permission::create([
            // 'name'=>'Creación de marcas',
            'name'          =>'marcas.create',
            'description'   =>'Crea cualquier dato de una marca del sistema.',
        ]);
        Permission::create([
            // 'name'=>'Elimina marcas',
            'name'          =>'marcas.destroy',
            'description'   =>'Elimina cualquier dato de una marca del sistema.',
        ]);
        // Tipo de equipo
        Permission::create([
            // 'name'=>'Navegar tipos',
            'name'          =>'tipos.index',
            'description'   =>'Lista y navega en los tipos de equipos del sistema.',
        ]);
        Permission::create([
            // 'name'=>'Edición de tipos',
            'name'          =>'tipos.edit',
            'description'   =>'Edita cualquier dato de los tipos de equipos del sistema.',
        ]);
        Permission::create([
            // 'name'=>'Creación de tipos',
            'name'          =>'tipos.create',
            'description'   =>'Crea cualquier dato de los tipos de equipos del sistema.',
        ]);
        Permission::create([
            // 'name'=>'Elimina tipos',
            'name'          =>'tipos.destroy',
            'description'   =>'Elimina cualquier dato de los tipos de equipos del sistema.',
        ]);
