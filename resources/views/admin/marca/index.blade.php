...
@section('content')
    ...
    <div class="card">
        <div class="card-body ">
            <table class="table table-striped mt-0.5 table-bordered shadow-lg mt-4 dt-responsive nowrap" id="marcas">
                ...
                <tbody>
                    @foreach ($marcas as $marca)
                        <tr>
                            <td style="width: 100px">{{ $marca->id }}</td>
                            <td>{{ ucwords($marca->nombre_marcas) }}</td>
